...
enum FpsLimitMethod {
	FPS_LIMIT_VSYNC, FPS_LIMIT_30, FPS_LIMIT_45, FPS_LIMIT_60, FPS_LIMIT_120, FPS_LIMIT_144, FPS_LIMIT_165, FPS_LIMIT_240, FPS_LIMIT_NONE, FPS_LIMIT_COUNT
};
